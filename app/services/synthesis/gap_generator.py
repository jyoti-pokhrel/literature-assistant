...
- NO PLACEHOLDERS: NEVER return the strings "undefined", "null", "N/A", or "unknown" for any field. If information is truly missing, provide a technical deduction or leave the field as an empty string.
...
def generate_gaps_for_cluster(
    ...
    try:
        ...
        def _clean_val(v, default=""):
            ...
            if len(s) < 80 and any(j in lower_s for j in ["undefined", "null", "[object"]):
                return default
